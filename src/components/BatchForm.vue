  ...
  <div class="batch-form">
    <div class="bg-card-bg rounded-xl border border-border p-5 md:p-6 space-y-5">
      ...
      <div class="space-y-1">
        ...
        <div class="relative">
          <select v-model="form.item_id" required :disabled="isEdit" class="w-full bg-hover-bg border border-border rounded-lg px-3 py-2 text-xs font-semibold text-text-primary outline-none focus:ring-1 focus:ring-emerald-500/20 appearance-none cursor-pointer disabled:opacity-50">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div class="space-y-1">
          ...
          <select v-model="form.supplier_id" class="w-full bg-hover-bg border border-border rounded-lg px-3 py-2 text-xs font-semibold text-text-primary outline-none focus:ring-1 focus:ring-emerald-500/20 appearance-none cursor-pointer">
