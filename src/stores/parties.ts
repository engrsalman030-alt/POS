        ...
        async addParty(party: any) {
            ...
            execute(
                `INSERT INTO parties (
                    ...
                    tax_id, cnic, reg_number, license_number, credit_limit, payment_terms, 
                    ...
                    is_active, notes, tags, company_type, default_percentage, code, area, area_id
                ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`,
                [
                    ...
                    party.tax_id || null, party.cnic || null, party.reg_number || null, party.license_number || null, party.credit_limit || 0, party.payment_terms || null,
                    ...
                    1, party.notes || null, party.tags || null, (party as any).company_type || null, (party as any).default_percentage || 0, (party as any).code || null, party.area || null, party.area_id || null
                ]
            );
        ...
        async updateParty(party: Party) {
            execute(
                ...
                [
                    ...
                    party.receivable_account_id || 'ar', party.payable_account_id || 'ap', party.opening_balance || 0, party.balance_type || 'Debit',
                    party.loyalty_program ? 1 : 0, party.customer_group || null, party.supplier_category || null, party.price_list || null, party.default_currency || null,
                    party.is_active ? 1 : 0, party.notes || null, party.tags || null, (party as any).company_type || null, (party as any).default_percentage || 0, (party as any).code || null, party.area || null, party.area_id || null,
                    party.id
                ]
            );
            await this.fetchParties();
